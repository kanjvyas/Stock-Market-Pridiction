...
stock_tickers = ["JSWSTEEL.NS", "TSLA", "GOOGL", "AMZN", "MSFT", "HDB", "NVDA", "ZOMATO.BO", "BAJAJFINSV.NS", "^NSEI",
...
"BOAT", "KOTAKBANK.NS", "MARUTI.BO", "ONGC.BO", "SPARC.NS", "TATAMOTORS.BO", "TECHM.BO", "WIPRO.NS", "BANKBARODA.BO", "IRCTC.BO",
